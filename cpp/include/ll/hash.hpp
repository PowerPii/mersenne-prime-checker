...
// Compute a stable 256-bit digest over arbitrary bytes (used to hash the
// residue limbs). Implementation can use SHA-256 (or any stable algorithm);
// callers don't depend on details.
